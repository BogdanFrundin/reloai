...
export const dictionaries: Record<Lang, Dictionary> = {
  ...
  uk: {
    ...
    profile: {
      title: "Профіль",
      subtitle: "Керуйте акаунтом і налаштуваннями.",
    ...
    community: {
      title: "Спільнота 🇵🇱",
      subtitle: "Telegram-канали, якими реально користуються ті, хто переїхав.",
      join: "Приєднатися",
      members: "учасників",
    ...
    onboarding: {
      ...
      goalOptions: {
        ...
        digitalNomad: "Цифровий кочівник",
