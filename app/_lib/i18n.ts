  ...
  en: {
    ...
    onboarding: {
      ...
      goalOptions: {
        ...
        passiveIncome: "Sufficient funds",
  ...
  ru: {
    ...
    onboarding: {
      ...
      goalOptions: {
        ...
        passiveIncome: "Достаточные средства",
  ...
  tr: {
    ...
    onboarding: {
      ...
      goalOptions: {
        ...
        study: "Eğitim",
        business: "İş kurma",
        passiveIncome: "Yeterli maddi kaynak",
