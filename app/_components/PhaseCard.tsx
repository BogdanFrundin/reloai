    ...
    <Reveal delay={index * 60}>
      <div className="relative flex gap-4 pb-8 last:pb-0">
        {!isLast && (
          <span
            aria-hidden
            className={`absolute left-5 top-12 w-px ${isDone ? "bg-emerald-400/40" : "bg-border-subtle"}`}
        ...
        <div
          className={`relative flex-1 overflow-hidden rounded-2xl p-5 transition-[border-color,opacity] duration-200 ease-[var(--ease-out-strong)] ${
            isActive
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-text-muted">{d.phaseDescriptions[phase.key]}</p>
