...
export default function DashboardSidebar({
  ...
  return (
    <>
      ...
      >
        <div className="flex-shrink-0 px-5 py-[clamp(0.5rem,3vh,1rem)]">
        ...
        <nav className="scrollbar-hide min-h-0 flex-1 space-y-[clamp(0.5rem,3vh,1rem)] overflow-y-auto px-3 py-1.5">
          <div className="border-b border-border-subtle pb-1">
            <Link
              href="/home"
              onClick={onClose}
              className={`flex items-center gap-3 rounded-xl border-l-2 px-3 py-[clamp(0.35rem,1.1vh,0.5rem)] text-sm font-medium transition-colors duration-150 ${
                pathname === "/home"
              ...
              {SERVICES_ORDER.map((key) => {
                ...
                return (
                  <Link
                    ...
                    href={href}
                    onClick={onClose}
                    className={`flex items-center gap-3 rounded-xl px-3 py-[clamp(0.35rem,1.1vh,0.5rem)] text-sm font-medium transition-colors duration-150 ${
        ...
        <div className="flex-shrink-0 space-y-[clamp(0.125rem,1vh,0.25rem)] border-t border-border-subtle p-[clamp(0.5rem,2.2vh,0.75rem)]">
          <Link
            href="/profile"
            onClick={onClose}
            className={`flex items-center gap-3 rounded-xl px-3 py-[clamp(0.35rem,1.1vh,0.5rem)] text-sm font-medium transition-colors duration-150 ${
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-xl px-3 py-[clamp(0.35rem,1.1vh,0.5rem)] text-left text-sm font-medium text-text-secondary transition-colors duration-150 hover:bg-surface-hover hover:text-text-primary"
          >
            {LOGOUT_ICON}
            <span>{s.logout}</span>
          </button>
