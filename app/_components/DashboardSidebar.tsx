  ...
  return (
    <>
      ...
      >
        ...
        <nav className="scrollbar-hide flex-1 space-y-2 overflow-y-auto px-3 py-1.5">
          <div className="border-b border-border-subtle pb-1">
            <Link
              href="/home"
              onClick={onClose}
              className={`flex items-center gap-3 rounded-xl border-l-2 px-3 py-1.5 text-[13px] font-medium transition-colors duration-150 ${
                pathname === "/home"
        ...
        <div className="space-y-0.5 border-t border-border-subtle p-2">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-xl px-3 py-1.5 text-left text-[13px] font-medium text-text-secondary transition-colors duration-150 hover:bg-surface-hover hover:text-text-primary"
          >
            {LOGOUT_ICON}
            <span>{s.logout}</span>
          </button>
