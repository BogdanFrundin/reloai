  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="mt-4 text-lg font-bold text-text-primary">{t.demo.promptHeading}</h2>
        <p className="mt-2 text-sm text-text-muted">{t.demo.promptBody}</p>
        <div className="mt-6 flex flex-col gap-2">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-full px-5 py-2.5 text-sm font-medium text-text-muted transition-colors duration-150 hover:text-text-primary"
          >
