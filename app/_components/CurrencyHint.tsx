  ...
  return (
    <>
      <span
        ...
        className="inline-flex flex-shrink-0 cursor-pointer items-center gap-0.5 rounded-full border border-white/15 bg-white/5 px-2 py-1 text-[10px] font-medium text-text-muted transition-[colors,background-color,border-color] duration-150 hover:border-accent/50 hover:bg-accent/10 hover:text-accent-bright"
      >
