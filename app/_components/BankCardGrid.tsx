      ...
      <div className="flex w-full flex-1 flex-col items-start gap-4 text-left">
        ...
        <div className="w-full min-w-0">
          ...
          <div className="mt-2 flex min-h-[1.5rem] items-center gap-1.5">
            <svg className="h-3 w-3 flex-shrink-0 text-white/40" viewBox="0 0 20 20" fill="currentColor">
              <path d="M10 2a4 4 0 100 8 4 4 0 000-8zM2 17a8 8 0 1116 0H2z" />
            </svg>
            <p className="text-xs text-white/40">{t.common.chosenByCountTemplate.replace("{n}", chosenCount)}</p>
          </div>
        </div>
      </div>
