...
update public.document_guides set tags = '["no_pesel", "free", "multicurrency"]'::jsonb where name = 'PKO Bank Polski' and category = 'финансы';
update public.document_guides set tags = '["no_pesel", "free", "multicurrency"]'::jsonb where name = 'Erste Bank Polska' and category = 'финансы';
update public.document_guides set tags = '["fully_online", "free", "multicurrency"]'::jsonb where name = 'Toyota Bank Polska' and category = 'финансы';
update public.document_guides set tags = '["no_pesel", "free", "multicurrency"]'::jsonb where name = 'VeloBank' and category = 'финансы';
update public.document_guides set tags = '["free", "multicurrency"]'::jsonb where name = 'Credit Agricole Bank Polska' and category = 'финансы';
update public.document_guides set tags = '["free", "multicurrency"]'::jsonb where name = 'ING Bank Śląski' and category = 'финансы';
update public.document_guides set tags = '["fully_online", "free", "multicurrency"]'::jsonb where name = 'mBank' and category = 'финансы';
...
update public.document_guides set tags = '["free", "multicurrency"]'::jsonb where name = 'Bank Pekao S.A.' and category = 'финансы';
update public.document_guides set tags = '["no_pesel", "free"]'::jsonb where name = 'Bank Pocztowy' and category = 'финансы';
